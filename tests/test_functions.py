...
import os
import json
from used_functions.functions_used import clear_me, save_settings, load_settings, settings_dok_file, mol2_to_ligands, parse_config
...
def test_settings_dok_file():
    ...
    new_save_path_dock = settings_dok_file(new_save_path_dock='tests/dock.in', rmsd_slider=rmsd_slider, dock_slider=dock_slider)
